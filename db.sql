...
CREATE TABLE instructor_extertise (iid integer NOT NULL, expertise varchar(200) NOT NULL, primary key(iid, expertise), foreign key(iid) references instructor(iid));
